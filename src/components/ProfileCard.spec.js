...
describe('ProfileCard', ()=>{
    describe('Layout', ()=>{
      ...
      it('displays displayName input when isEditMode property is set as true', ()=>{
      ...
      it('displays the current displayName in input when in Edit Mode ', ()=>{
      ...
      it('displays file input when inEditMode property is set as true', ()=>{
